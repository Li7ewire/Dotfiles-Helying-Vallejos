...
set -U fish_user_abbreviations $fish_user_abbreviatons 'l=exa'
set -U fish_user_abbreviations $fish_user_abbreviatons 'ls=exa'
set -U fish_user_abbreviations $fish_user_abbreviatons 'll=exa -l'
set -U fish_user_abbreviations $fish_user_abbreviatons 'lll=exa -ls'
